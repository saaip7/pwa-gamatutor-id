...
export function AchievementBanner({ unlockedCount, totalCount, className }: AchievementBannerProps) {
  ...
  return (
    ...
    >
      <Link href="/mastery" className="block group">
        <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm p-5 relative overflow-hidden active:scale-[0.98] transition-all">
          {/* Background Accent */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 blur-3xl group-hover:bg-primary/10 transition-colors" />
          
          <div className="flex items-center gap-4 relative z-10">
            {/* Trophy Icon Area (Shadow removed) */}
