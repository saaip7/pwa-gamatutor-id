...
export function ReflectionForm({ strategyName, mainGoal }: ReflectionFormProps) {
    ...
    >
      ...
      <motion.section variants={itemVariants} className="space-y-4">
        ...
        <div className="flex gap-3">
          {[
            { id: "ya", label: "Ya", icon: CheckCircle, color: "text-emerald-600", active: "border-emerald-500 bg-emerald-50 text-emerald-700" },
            { id: "sebagian", label: "Sebagian", icon: MinusCircle, color: "text-amber-600", active: "border-amber-500 bg-amber-50 text-amber-700" },
            { id: "tidak", label: "Tidak", icon: XCircle, color: "text-rose-600", active: "border-rose-500 bg-rose-50 text-rose-700" },
          ].map((opt) => (
            <button
              key={opt.id}
              type="button"
