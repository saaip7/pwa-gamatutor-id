...
export const ITEMS: ItemDef[] = [
  ...
  { id: "lv1", slot: "head", name: "Casual", level: 1, unlockStreak: 3 },
  { id: "lv2", slot: "head", name: "Sporty", level: 2, unlockStreak: 7 },
  { id: "lv3", slot: "head", name: "Stylish", level: 3, unlockStreak: 14 },
  { id: "lv4", slot: "head", name: "Elite", level: 4, unlockStreak: 21 },
  // Top
  { id: "base", slot: "top", name: "Default", level: 0, unlockStreak: 0 },
  { id: "lv1", slot: "top", name: "Hoodie", level: 1, unlockStreak: 3 },
  { id: "lv2", slot: "top", name: "Jacket", level: 2, unlockStreak: 7 },
  { id: "lv3", slot: "top", name: "Blazer", level: 3, unlockStreak: 14 },
  { id: "lv4", slot: "top", name: "Armor", level: 4, unlockStreak: 21 },
  { id: "lv5", slot: "top", name: "Royal", level: 5, unlockStreak: 30 },
  // Bottom
...
export function getItemsBySlot(slot: "head" | "top" | "bottom" | "special") {
  return ITEMS.filter((item) => item.slot === slot);
}

// Slot-level to component mapping
const HEAD_COMPONENTS: Record<SlotLevel, React.FC<{ gender: Gender }>> = {
  base: HeadBase,
  lv1: HeadLv1,
  lv2: HeadLv2,
  lv3: HeadLv3,
...
const TOP_COMPONENTS: Record<SlotLevel, React.FC<{ gender: Gender }>> = {
  base: TopBase,
  lv1: TopLv1,
  lv2: TopLv2,
  lv3: TopLv3,
...
const BOTTOM_COMPONENTS: Record<SlotLevel, React.FC<{ gender: Gender }>> = {
  base: BottomBase,
  lv1: BottomLv1,
  lv2: BottomLv2,
  lv3: BottomLv3,
