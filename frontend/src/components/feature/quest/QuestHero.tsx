    ...
    <div className={cn("relative", className)}>
      <div
        className={cn(
          ...
          isCompleted
            ? "border-emerald-200 bg-emerald-50/50 shadow-[0_0_0_1px_rgba(16,185,129,0.1),0_2px_16px_-2px_rgba(16,185,129,0.12)]"
            : "border-[var(--primary)]/25 shadow-[0_0_0_1px_rgba(59,130,246,0.08),0_2px_16px_-2px_rgba(59,130,246,0.15)] quest-shine",
        )}
      >
        <div className="relative z-10 px-5 py-4">
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className={cn(
                ...
                {isCompleted ? "Selesai" : "Quest Aktif"}
              </span>
            </div>
            ...
            <div className={cn(
              ...
              isCompleted ? "bg-emerald-100" : "bg-[var(--primary)]/8",
            )}>
              ...
              <span className={cn(
                ...
                isCompleted ? "text-emerald-700" : "text-[var(--primary)]",
              )}>
                {cfg.label}
              </span>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={cn(
              ...
              isCompleted ? "text-emerald-500" : "text-neutral-500",
            )}>
