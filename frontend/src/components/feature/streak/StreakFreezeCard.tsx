    ...
    <div className="bg-white border border-neutral-200 rounded-2xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)] flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-[15px] font-bold text-neutral-900 leading-tight">Pelindung Streak</h3>
        </div>
        <div className="bg-blue-100 text-blue-600 px-3 py-1 rounded-lg flex items-center justify-center min-w-[36px]">
          <span className="text-[13px] font-bold leading-none">{available}</span>
        </div>
      </div>
      <button
        onClick={onUse}
        disabled={available <= 0}
        className="w-full h-10 bg-white border border-neutral-200 shadow-sm text-[14px] font-semibold text-neutral-700 rounded-xl hover:bg-neutral-50 hover:border-neutral-300 active:bg-neutral-100 transition-all flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
      >
