...
export function TaskDistributionChart({ data }: TaskDistributionChartProps) {
  // Convert percentages to conic-gradient stops
  ...
  return (
    ...
    >
      <h3 className="text-sm font-bold text-neutral-800 mb-5">Task Distribution</h3>
      
      <div className="flex items-center gap-6">
        {/* Doughnut Chart */}
        <div className="relative w-[100px] h-[100px] shrink-0">
          {/* Conic Gradient matching colors */}
          ...
          <div className="absolute inset-[22%] bg-white rounded-full flex flex-col items-center justify-center shadow-inner">
            ...
            <span className="text-[10px] text-neutral-500 mt-0.5">tasks</span>
          </div>
        </div>
        ...
        <div className="flex-1 grid grid-cols-2 gap-y-3 gap-x-2">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-bold text-neutral-800">TODO</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-bold text-neutral-800">IN PROG</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-bold text-neutral-800">REVIEW</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-bold text-neutral-800">DONE</span>
