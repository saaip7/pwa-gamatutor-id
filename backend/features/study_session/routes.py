...
from features.study_session.controller import start, end, heartbeat, get_session, get_card_sessions, get_history, get_top_sessions
...
study_session_bp.route("/api/study-sessions/top", methods=["GET"])(get_top_sessions)
